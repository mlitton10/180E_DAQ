...
import time
import datetime
from widgets.Motor_Control_2D_xy import Motor_Control_2D
from widgets.LecroyScope import LecroyScope, WAVEDESC_SIZE
from widgets.LecroyScope import EXPANDED_TRACE_NAMES
import tkinter
